...
public class FriendService {
     ...
     */
    public User findFriend(String friendId) throws NoSuchUserException {
     ...
     * @param friend 사용자가 검색한 유저
     * @throws NoSuchUserException
     */
    public void addFriend(User user, User friend) throws DuplicateFriendException {
        validateDuplicatedFriend(user, friend);
        FriendId friendId = new FriendId(user.getId(), friend.getId());
        Friend friendRelation = new Friend(friendId, user, friend);
